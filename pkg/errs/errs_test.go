...
func (es *ErrsSuite) TestErrsObjectCreation() {
	...
	es.EqualError(err, "code=212;code_detail=212;status=FAILED;message=ERROR_TEST_MESSAGE;error=ERROR_TEST;location=github.com/mhaikalla/parking-service-management-library/pkg/errs.(*ErrsSuite).TestErrsObjectCreation:19")
